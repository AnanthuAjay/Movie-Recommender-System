...
df = pd.read_csv(r'C:\Users\DELL\Movie-Recommender-in-python\u.data', sep='\t', names=column_names)
...
movie_titles = pd.read_csv(r"C:\Users\DELL\Movie-Recommender-in-python\Movie_Id_Titles")
movie_titles.head()
...
# Okay! Now let's move on to creating a simple recommendation system:
